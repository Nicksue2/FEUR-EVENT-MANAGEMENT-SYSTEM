...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (path.includes('signup.html')) {
        ...
        if(signupForm) signupForm.addEventListener('submit', async (e) => {
            ...
            // Updated to allow your Gmail testing, comment out if you want strict FEU emails
            /*
            if (!email.endsWith('@feuroosevelt.edu.ph')) {
                showCustomAlert('Error', 'Please use your official @feuroosevelt.edu.ph email account.');
        ...
        if (modalRegBtn) {
            modalRegBtn.addEventListener('click', async () => {
                ...
                if (existingRegistration && existingRegistration.length > 0) {
                    ...
                    return; // Stays disabled and stops process
                }
